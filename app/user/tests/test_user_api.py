...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Test creating user tha already exists fails"""
        payload = {'email': 'rajkingpin910@gmail.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'rajkingpin910@gmail.com', 'password': 'pw'}
        payload = {
            'email': 'rajkingpin910@gmail.com',
            'password': 'pw',
            'name': 'Test',
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='rajkingpin910@gmail.com')
        payload = {'email': 'rajkingpin910@gmail.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
